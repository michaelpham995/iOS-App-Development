    ...
    */
    ...
    @IBAction func doneBtn(_ sender: Any) {
        if let missingItem = missingIngredientNotification(){
            ...
            savePizza(size, typeCrust, typeCheese, typeMeat, typeVeggies)
    ...
    func savePizza(_ size: String, _ typeCrust: String, _ typeCheese: String, _ typeMeat: String, _ typeVeggies: String){
        let appDelegate = UIApplication.shared.delegate as! AppDelegate
        let context = appDelegate.persistentContainer.viewContext
        let pizza = NSEntityDescription.insertNewObject(forEntityName: "Pizza", into: context)
        
        pizza.setValue(size, forKey: "size")
        pizza.setValue(typeCrust, forKey: "typeCrust")
        pizza.setValue(typeCheese, forKey: "typeCheese")
        pizza.setValue(typeMeat, forKey: "typeMeat")
        pizza.setValue(typeVeggies, forKey: "typeVeggies")
        
        //Now we commit these changes into the data
        do{
            try context.save()
        } catch{
